using AlloyLocalizedSql.Helpers;
using AlloyLocalizedSql.Models.Blocks;
using AlloyLocalizedSql.Models.Pages;
using AlloyLocalizedSql.Models.ViewModels;
using EPiServer.Web;
using EPiServer.Web.Mvc;
using Microsoft.AspNetCore.Html;
using Microsoft.AspNetCore.Mvc;

namespace AlloyLocalizedSql.Components;
